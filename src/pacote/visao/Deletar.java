...
public class Deletar extends javax.swing.JFrame {
    ...
    public Deletar() {
        ...
        {
            Object[] dados = {pessoa.getId(), pessoa.getNome()};
            modelo.addRow(dados);
        }
...
//        tabelaDados.getColumnModel().getColumn(0).setMaxWidth(0);
    ...
    private void tabelaDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaDadosMouseClicked
        ...
        if(resposta == 0)
        {
            ...
            Integer matricula = (Integer)tabelaDados.getValueAt(linha, 0);
            DAOPessoa remover = new DAOPessoa();
            if(remover.removePessoa(matricula))
            {
