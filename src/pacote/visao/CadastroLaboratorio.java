...
public class CadastroLaboratorio extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Cadastro Laboratorio
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro Laboratório");
        ...
        comboEspecialidade.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Farmacêutico", "Capilar" }));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(campoDataEntrega, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
        ...
        laboratorio.setNome(campoNome.getText());
        laboratorio.setDataEntrega(converteStringDate(campoDataEntrega.getText()));
        laboratorio.setEspecialidade(comboEspecialidade.getSelectedItem().toString());
        laboratorio.setCnpj(Integer.parseInt(campoCnpj.getText()));
        
        DAOLaboratorio insereDados = new DAOLaboratorio();
        if(insereDados.insereLaboratorio(laboratorio))
        {
    ...
    public Date converteStringDate(String data) 
    {
        ...
        try {
            ...
            Logger.getLogger(CadastroLaboratorio.class.getName()).log(Level.SEVERE, null, ex);
        }
        return date;
    }
    ...
    public void limparCampos()
    {
        ...
        campoCnpj.setText("");
        comboEspecialidade.setSelectedItem("Farmacêutico");
    }
